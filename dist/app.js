...
/***/ function(module, exports) {
	...
	var _user$project$Button_Model$size = 500;
	var _user$project$Button_Model$Button = function (a) {
		return function (b) {
			return function (c) {
				return function (d) {
					return function (e) {
								...
								return function (h) {
									return function (i) {
										return function (j) {
											return function (k) {
												return function (l) {
													return {hint: a, iconSrc: b, activeIconSrc: c, angle: d, innerRadius: e, outerRadius: f, x: g, y: h, id: i, clock: j, state: k, outerRadiusRange: l};
												};
											};
										};
									};
	...
	var _user$project$Button_Model$Gone = {ctor: 'Gone'};
	var _user$project$Button_Model$initBtn = F7(
		function (angle, x, y, outerRadius, innerRadius, index, _p0) {
			var _p1 = _p0;
			var _p2 = _p1._2;
			var active = 'active/';
			var ext = '.svg';
			var imgDir = './Button/img/';
			return {
				hint: _p1._1,
				iconSrc: A2(
					_elm_lang$core$Basics_ops['++'],
					imgDir,
					A2(_elm_lang$core$Basics_ops['++'], _p2, ext)),
				activeIconSrc: A2(
					_elm_lang$core$Basics_ops['++'],
					imgDir,
					A2(
				...
				id: _p1._0,
				angle: angle,
				innerRadius: _mgold$elm_animation$Animation$static(innerRadius),
				outerRadius: _mgold$elm_animation$Animation$static(0),
				outerRadiusRange: {ctor: '_Tuple2', _0: outerRadius - 12, _1: outerRadius},
				x: x,
				y: y,
				clock: 0,
				state: _user$project$Button_Model$Gone
			};
		});
	var _user$project$Button_Model$initialButtons = function (size) {
		var buttons = _elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple3', _0: 1, _1: 'accessibility', _2: 'accessibility'},
				{ctor: '_Tuple3', _0: 2, _1: 'call', _2: 'call'},
				{ctor: '_Tuple3', _0: 3, _1: 'mail', _2: 'mail'},
				{ctor: '_Tuple3', _0: 4, _1: 'mic', _2: 'mic'},
				{ctor: '_Tuple3', _0: 5, _1: 'room', _2: 'room'},
				{ctor: '_Tuple3', _0: 6, _1: 'send', _2: 'send'},
				{ctor: '_Tuple3', _0: 7, _1: 'spellcheck', _2: 'spellcheck'}
			]);
		...
		return A2(
			...
			A5(
				_user$project$Button_Model$initBtn,
				360.0 / _elm_lang$core$Basics$toFloat(
					_elm_lang$core$List$length(buttons)),
				x,
				y,
				outerRadius,
				innerRadius),
	...
	var _user$project$Button_Model$Exiting = {ctor: 'Exiting'};
	var _user$project$Button_Model$Entering = {ctor: 'Entering'};
	var _user$project$Button_Model$Small = {ctor: 'Small'};
	var _user$project$Button_Model$Here = {ctor: 'Here'};
	var _user$project$Button_Model$Shrinking = {ctor: 'Shrinking'};
	var _user$project$Button_Model$Growing = {ctor: 'Growing'};

	var _user$project$Button_Msg$Tick = function (a) {
		return {ctor: 'Tick', _0: a};
	};
	var _user$project$Button_Msg$HideAll = {ctor: 'HideAll'};
	var _user$project$Button_Msg$Show = F4(
		function (a, b, c, d) {
			return {ctor: 'Show', _0: a, _1: b, _2: c, _3: d};
		});
	var _user$project$Button_Msg$ShowAll = F2(
		function (a, b) {
			return {ctor: 'ShowAll', _0: a, _1: b};
		});
	var _user$project$Button_Msg$DeActivate = function (a) {
		return {ctor: 'DeActivate', _0: a};
	};
	var _user$project$Button_Msg$Activate = function (a) {
		return {ctor: 'Activate', _0: a};
	};

	var _user$project$Button_Update$subscriptions = function (buttons) {
		return _elm_lang$core$Platform_Sub$batch(
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$animation_frame$AnimationFrame$diffs(_user$project$Button_Msg$Tick)
				]));
	};
	var _user$project$Button_Update$randomFloat = A2(_elm_lang$core$Random$float, 0.5, 1);
	var _user$project$Button_Update$updateButton = F2(
		function (msg, model) {
			var _p0 = msg;
			switch (_p0.ctor) {
				case 'Tick':
					var clock = model.clock + _p0._0;
					var radiusDone = A2(_mgold$elm_animation$Animation$isDone, clock, model.outerRadius);
					var state = function () {
						var _p1 = model.state;
						switch (_p1.ctor) {
							case 'Growing':
								return radiusDone ? _user$project$Button_Model$Here : _user$project$Button_Model$Growing;
							case 'Shrinking':
								return radiusDone ? _user$project$Button_Model$Small : _user$project$Button_Model$Shrinking;
							case 'Entering':
								return radiusDone ? _user$project$Button_Model$Here : _user$project$Button_Model$Entering;
							case 'Exiting':
								return radiusDone ? _user$project$Button_Model$Gone : _user$project$Button_Model$Exiting;
							default:
								return model.state;
						}
					}();
				...
				case 'Activate':
					if (!_elm_lang$core$Native_Utils.eq(_p0._0, model.id)) {
						return model;
					} else {
						var big_r = _elm_lang$core$Basics$snd(model.outerRadiusRange);
						var small_r = _elm_lang$core$Basics$fst(model.outerRadiusRange);
						...
						var model$ = _elm_lang$core$Native_Utils.update(
							model,
							{
								outerRadius: A2(
									...
									_elm_community$easing_functions$Ease$linear,
									A2(
										_mgold$elm_animation$Animation$duration,
										200,
										A3(_mgold$elm_animation$Animation$retarget, now, small_r, model.outerRadius))),
								state: _user$project$Button_Model$Shrinking
							});
						var _p2 = model.state;
						switch (_p2.ctor) {
							case 'Here':
											...
											A2(
												...
												A2(
													...
													A2(
														...
														big_r,
														_mgold$elm_animation$Animation$animation(now))))),
										state: _user$project$Button_Model$Shrinking
									});
							case 'Growing':
								return model$;
				...
				case 'DeActivate':
					if (!_elm_lang$core$Native_Utils.eq(_p0._0, model.id)) {
						...
						var small_r = _elm_lang$core$Basics$fst(model.outerRadiusRange);
						var big_r = _elm_lang$core$Basics$snd(model.outerRadiusRange);
						var growingOrBig = _elm_lang$core$Native_Utils.eq(model.state, _user$project$Button_Model$Small) || _elm_lang$core$Native_Utils.eq(model.state, _user$project$Button_Model$Shrinking);
						var state = model.state;
						var now = model.clock;
						var _p3 = model.state;
						switch (_p3.ctor) {
											...
											A2(
												...
												A2(
													...
													A2(
														...
														small_r,
														_mgold$elm_animation$Animation$animation(now))))),
										state: _user$project$Button_Model$Growing
									});
							case 'Shrinking':
								return _elm_lang$core$Native_Utils.update(
									model,
									{
										outerRadius: A2(
											...
											A2(
												_mgold$elm_animation$Animation$duration,
												500,
												A3(_mgold$elm_animation$Animation$retarget, now, big_r, model.outerRadius))),
										state: _user$project$Button_Model$Growing
									});
							default:
								return model;
						...
						if (_p4.ctor === 'Gone') {
							return _elm_lang$core$Native_Utils.update(
								model,
								{
									x: _p0._1,
									y: _p0._2,
									state: _user$project$Button_Model$Entering,
									outerRadius: A2(
										_mgold$elm_animation$Animation$ease,
										_elm_community$easing_functions$Ease$outElastic,
										A2(
											...
											A2(
												_mgold$elm_animation$Animation$to,
												_elm_lang$core$Basics$snd(model.outerRadiusRange),
												A2(
													_mgold$elm_animation$Animation$from,
													0,
													_mgold$elm_animation$Animation$animation(model.clock))))),
									innerRadius: A2(
										_mgold$elm_animation$Animation$duration,
										0,
										A2(_mgold$elm_animation$Animation$undo, model.clock, model.innerRadius))
								});
						} else {
							return model;
						}
				...
				case 'HideAll':
					...
					if (_p5.ctor === 'Exiting') {
						...
						return _elm_lang$core$Native_Utils.update(
							model,
							{
								state: _user$project$Button_Model$Exiting,
								outerRadius: A2(
									_mgold$elm_animation$Animation$duration,
									200,
									A2(
								...
								innerRadius: A2(
									_mgold$elm_animation$Animation$duration,
									200,
									A3(_mgold$elm_animation$Animation$retarget, model.clock, 0, model.innerRadius))
							});
					}
				default:
					return model;
	...
	var _user$project$Button_Update$update = F2(
			...
			switch (_p6.ctor) {
				case 'Activate':
					return {
						...
						_0: A2(
							_elm_lang$core$List$map,
							_user$project$Button_Update$updateButton(msg),
							buttons),
						...
						_1: _elm_lang$core$Platform_Cmd$batch(
							A2(
								...
								function (btn) {
									return A2(
										_elm_lang$core$Random$generate,
										A3(_user$project$Button_Msg$Show, btn.id, _p6._0, _p6._1),
										_user$project$Button_Update$randomFloat);
								},
								buttons))
					};
			}
	...
	var _user$project$Button_View$renderIcon = F2(
		function (button, outerRadius) {
			return A2(
				_elm_lang$svg$Svg$image,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$svg$Svg_Attributes$xlinkHref(
						_elm_lang$core$Native_Utils.eq(button.state, _user$project$Button_Model$Small) ? button.activeIconSrc : button.iconSrc),
						_elm_lang$svg$Svg_Attributes$width('24'),
						_elm_lang$svg$Svg_Attributes$height('24'),
						function (_p0) {
						...
						((button.y - 15) - outerRadius) + A2(_mgold$elm_animation$Animation$animate, button.clock, button.innerRadius)),
						_elm_lang$svg$Svg_Attributes$class(
						A2(
							_elm_lang$core$Basics_ops['++'],
							'radialnav-icon ',
							(_elm_lang$core$Native_Utils.eq(button.state, _user$project$Button_Model$Gone) || _elm_lang$core$Native_Utils.eq(button.state, _user$project$Button_Model$Exiting)) ? 'hide' : '')),
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(button.angle / 2),
								A2(
									_elm_lang$core$Basics_ops['++'],
									',',
									A2(
										_elm_lang$core$Basics_ops['++'],
										_elm_lang$core$Basics$toString(button.x),
										A2(
											_elm_lang$core$Basics_ops['++'],
											',',
											A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString(button.y),
												')')))))))
					]),
				_elm_lang$core$Native_List.fromArray(
					[]));
		});
	var _user$project$Button_View$rotateButton = F2(
			...
			return A2(
				...
				A2(
					...
					_elm_lang$core$Basics$toString(
						button.angle * _elm_lang$core$Basics$toFloat(index)),
					A2(
						_elm_lang$core$Basics_ops['++'],
						',',
						A2(
	...
	var _user$project$Button_View$polarToCartesian = F4(
		function (cx, cy, r, a) {
			var angle = ((a - 90) * _elm_lang$core$Basics$pi) / 180;
			var shift = function (_p2) {
				var _p3 = _p2;
				return {x: _p3._0 + cx, y: _p3._1 + cy};
			};
			return shift(
				_elm_lang$core$Basics$fromPolar(
					{ctor: '_Tuple2', _0: r, _1: angle}));
		});
	var _user$project$Button_View$describeArc = F6(
		function (x, y, r, startAngle, endAngle, continueLine) {
			var alter = (_elm_lang$core$Native_Utils.cmp(endAngle, startAngle) > 0) ? 1 : 0;
			var buildString = F2(
				function (a, b) {
					return A2(_elm_lang$core$Basics_ops['++'], a, b);
				});
			var large = (_elm_lang$core$Native_Utils.cmp(
				_elm_lang$core$Basics$abs(endAngle - startAngle),
				180) > -1) ? 1 : 0;
			var end = A4(_user$project$Button_View$polarToCartesian, x, y, r, endAngle);
			var start = A4(_user$project$Button_View$polarToCartesian, x, y, r, startAngle);
			return A3(
				_elm_lang$core$List$foldr,
				F2(
					function (x, y) {
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Basics$toString(r),
						',0 ',
						_elm_lang$core$Basics$toString(large),
						' ',
						_elm_lang$core$Basics$toString(alter),
						',',
	...
	var _user$project$Button_View$describeSector = F6(
		function (x, y, r, r2, startAngle, endAngle) {
			return A2(
				_elm_lang$core$Basics_ops['++'],
				A6(_user$project$Button_View$describeArc, x, y, r, startAngle, endAngle, false),
				A2(
					_elm_lang$core$Basics_ops['++'],
					' ',
					A2(
						_elm_lang$core$Basics_ops['++'],
						A6(_user$project$Button_View$describeArc, x, y, r2, endAngle, startAngle, true),
						' Z')));
		});
	var _user$project$Button_View$createDefs = F2(
		function (pathId, button) {
			return A2(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								A6(
									_user$project$Button_View$describeArc,
									button.x,
									button.y,
									_elm_lang$core$Basics$snd(button.outerRadiusRange),
									0,
									button.angle,
									false)),
								_elm_lang$svg$Svg_Attributes$id(pathId)
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					]));
		});
	var _user$project$Button_View$renderHint = function (button) {
		var id$ = _elm_lang$core$Basics$toString(button.id);
		var pathId = A2(_elm_lang$core$Basics_ops['++'], 'path-', id$);
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						'radialnav-hint ',
						_elm_lang$core$Native_Utils.eq(button.state, _user$project$Button_Model$Small) ? 'active' : (_elm_lang$core$Native_Utils.eq(button.state, _user$project$Button_Model$Here) ? 'hide' : '')))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_user$project$Button_View$createDefs, pathId, button),
					A2(
					_elm_lang$svg$Svg$textPath,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$svg$Svg_Attributes$xlinkHref(
							A2(_elm_lang$core$Basics_ops['++'], '#', pathId)),
							_elm_lang$svg$Svg_Attributes$startOffset('50%')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$svg$Svg$text(button.hint)
						]))
				]));
	};
	var _user$project$Button_View$renderButton = F2(
		function (index, model) {
			var outerRadius = A2(_mgold$elm_animation$Animation$animate, model.clock, model.outerRadius);
			return {
				ctor: '_Tuple2',
				...
				_1: A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$svg$Svg_Attributes$transform(
							A2(_user$project$Button_View$rotateButton, model, index)),
							_elm_lang$svg$Svg_Events$onMouseOut(
							_user$project$Button_Msg$DeActivate(model.id)),
							_elm_lang$svg$Svg_Events$onMouseOver(
							_user$project$Button_Msg$Activate(model.id))
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$svg$Svg_Attributes$d(
									A6(
										_user$project$Button_View$describeSector,
										model.x,
										model.y,
										outerRadius,
										A2(_mgold$elm_animation$Animation$animate, model.clock, model.innerRadius),
										0,
										model.angle)),
									_elm_lang$svg$Svg_Attributes$class(
									A2(
										_elm_lang$core$Basics_ops['++'],
										'radialnav-sector ',
										(_elm_lang$core$Native_Utils.eq(model.state, _user$project$Button_Model$Small) || _elm_lang$core$Native_Utils.eq(model.state, _user$project$Button_Model$Shrinking)) ? 'active' : (_elm_lang$core$Native_Utils.eq(model.state, _user$project$Button_Model$Gone) ? 'hide' : '')))
								]),
							_elm_lang$core$Native_List.fromArray(
								[])),
							A2(_user$project$Button_View$renderIcon, model, outerRadius),
							_user$project$Button_View$renderHint(model)
						]))
			};
		});
	var _user$project$Button_View$view = function (buttons) {
		return A3(
			_elm_lang$svg$Svg_Keyed$node,
			'g',
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$svg$Svg_Attributes$class('radialnav')
				]),
			A2(_elm_lang$core$List$indexedMap, _user$project$Button_View$renderButton, buttons));
	};
	var _user$project$Button_View$Cartesian = F2(
		function (a, b) {
			return {x: a, y: b};
		});

	var _user$project$Main$size = 500;
	var _user$project$Main$init = {
		buttons: _user$project$Button_Model$initialButtons(_user$project$Main$size),
		menuShowed: false,
		size: A2(_elm_lang$window$Window$Size, 0, 0)
	};
	var _user$project$Main$Model = F3(
		function (a, b, c) {
			return {buttons: a, menuShowed: b, size: c};
		});
	var _user$project$Main$SizeChange = function (a) {
		return {ctor: 'SizeChange', _0: a};
	};
	var _user$project$Main$ToggleMenu = F2(
		function (a, b) {
			return {ctor: 'ToggleMenu', _0: a, _1: b};
		});
	var _user$project$Main$eventPos = A3(
		_elm_lang$core$Json_Decode$object2,
		_user$project$Main$ToggleMenu,
	...
	var _user$project$Main$update = F2(
		function (msg, model) {
			...
			switch (_p0.ctor) {
				case 'ButtonMsg':
					var _p1 = A2(_user$project$Button_Update$update, _p0._0, model.buttons);
					var updatedButtons = _p1._0;
					var buttonCmd = _p1._1;
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{buttons: updatedButtons}),
						_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$ButtonMsg, buttonCmd)
					};
				case 'ToggleMenu':
					if (A2(_elm_lang$core$Debug$log, 'SHOWED', model.menuShowed)) {
						var _p2 = A2(_user$project$Button_Update$update, _user$project$Button_Msg$HideAll, model.buttons);
						var updatedButtons = _p2._0;
						var buttonCmd = _p2._1;
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{buttons: updatedButtons, menuShowed: false}),
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$ButtonMsg, buttonCmd)
						};
					} else {
						var _p3 = A2(
							_user$project$Button_Update$update,
							A2(_user$project$Button_Msg$ShowAll, _p0._0, _p0._1),
							model.buttons);
						var updatedButtons = _p3._0;
						var buttonCmd = _p3._1;
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{buttons: updatedButtons, menuShowed: true}),
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$ButtonMsg, buttonCmd)
						};
					}
				case 'SizeChange':
		...
		return _elm_lang$core$Platform_Sub$batch(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_user$project$Button_Update$subscriptions(model.buttons)),
					_elm_lang$window$Window$resizes(_user$project$Main$SizeChange)
				]));
	};
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Basics$toString(model.size.height)),
					_elm_lang$svg$Svg_Attributes$class('radialnav'),
					A2(_elm_lang$svg$Svg_Events$on, 'click', _user$project$Main$eventPos)
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_user$project$Main$ButtonMsg,
					_user$project$Button_View$view(model.buttons))
				]));
	};
